        ...
        {!readOnly && keys.length < MAX_TEMPLATE_IMAGES_PER_NODE && (
          <>
            ...
            <button
              ...
              disabled={uploading}
              className="border-border text-muted-foreground hover:text-foreground flex items-center gap-1 rounded-lg border border-dashed px-2 py-1.5 text-xs disabled:opacity-50"
            >
